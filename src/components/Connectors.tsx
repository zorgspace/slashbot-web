  ...
  const connectors = [
    {
      ...
      color: "#0088cc",
      description: "Full Telegraf-based bot integration with private chat and group support.",
      features: [
    ...
    },
    {
      ...
      color: "#5865F2",
      description: "Discord.js with Socket Mode. Separate agent sessions for guilds and DMs.",
      features: [
    ...
    },
    {
      ...
      color: "#4A154B",
      description: "@slack/bolt with Socket Mode. Events API, slash commands, and threaded replies.",
      features: [
        "Voice transcription",
        "Threaded replies",
        "File attachments",
    ...
    },
    {
      ...
      color: "#25D366",
      description: "WebSocket bridge connector for WhatsApp. Text, media, and voice support.",
      features: [
        "Voice message transcription",
        "Media support",
